//------------------------------------------------------------------------------------------
const char murottalAuto3Setting[] PROGMEM = R"=====(

<!DOCTYPE HTML><html>
<head>
  <title>PENGATURAN MUROTTAL AUTO 3</title>
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" type="text/css" href="style.css">
</head>
<body onload="myFunction()">
  <iframe src="daftar-isi" height="200" width="300" id="daftar-isi" style="display:none"></iframe>
  <iframe src="playPropertiesMurottal3" height="200" width="300" id="playPropertiesMurottal" style="display:none"></iframe>
  ...
  <div class="form">
    <div class="title">PENGATURAN MUROTTAL AUTO 3</div>
      <form action="/get">   
        <input type="checkbox" id="auto3SettingCBId" name="auto3SettingCB" value="1" style="visibility:hidden;">
...
function myFunction(){
  document.getElementById("auto3SettingCBId").checked = true;
