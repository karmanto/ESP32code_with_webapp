//------------------------------------------------------------------------------------------
const char murottalAuto2Setting[] PROGMEM = R"=====(

<!DOCTYPE HTML><html>
<head>
  <title>PENGATURAN MUROTTAL AUTO 2</title>
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" type="text/css" href="style.css">
</head>
<body onload="myFunction()">
  <iframe src="daftar-isi" height="200" width="300" id="daftar-isi" style="display:none"></iframe>
  <iframe src="playPropertiesMurottal2" height="200" width="300" id="playPropertiesMurottal" style="display:none"></iframe>
  ...
  <div class="form">
    <div class="title">PENGATURAN MUROTTAL AUTO 2</div>
      <form action="/get">   
        <input type="checkbox" id="auto2SettingCBId" name="auto2SettingCB" value="1" style="visibility:hidden;">
...
function myFunction(){
  document.getElementById("auto2SettingCBId").checked = true;
